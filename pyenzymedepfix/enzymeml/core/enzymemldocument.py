...
from pyenzymedepfix.enzymeml.core.enzymemlbase import EnzymeMLBase
...
from pyenzymedepfix.enzymeml.tools.templatereader import read_template
from pyenzymedepfix.enzymeml.tools.validator import EnzymeMLValidator

from pyenzymedepfix.enzymeml.core.ontology import EnzymeMLPart, SBOTerm
from pyenzymedepfix.utils.log import setup_custom_logger, log_object
from pyenzymedepfix.enzymeml.core.exceptions import SpeciesNotFoundError
from pyenzymedepfix.enzymeml.core.utils import type_checking, deprecated_getter
...
class EnzymeMLDocument(EnzymeMLBase):
    ...
    def fromFile(path: str):
        ...
        from pyenzymedepfix.enzymeml.tools.enzymemlreader import EnzymeMLReader
    ...
    def uploadToDataverse(
        ...
        try:
            from pyenzymedepfix.enzymeml.databases.dataverse import uploadToDataverse
